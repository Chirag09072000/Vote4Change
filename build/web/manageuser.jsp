...
<%
    ...
    displayBlock.append("<div id='dv1' onclick='showuserstable()'>"
    + "<img src='images/show.png' height='250px' width='250px'>"
    + "<br><h3>Show Users</h3></div>");
    displayBlock.append("<div id='dv2' onclick='removeuserform()'>"
    + "<img src='images/delete.jpg' height='250px' width='250px'>"
